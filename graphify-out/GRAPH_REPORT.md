...
## Corpus Check
- 68 files · ~38,650 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 470 nodes · 478 edges · 44 communities (37 shown, 7 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 2 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `4281bb20`
...
Cohesion: 0.16
Nodes (21): db, sqlite, rodarMigracoes(), seed(), validarJWT(), verificarRole(), validarCSRF(), rotasAdmin() (+13 more)
...
Cohesion: 0.40
Nodes (4): CriarProdutoInput, CriarProdutoSchema, RespostaProduto, RespostaProdutoSchema
...
## Knowledge Gaps
- **282 isolated node(s):** `check-prerequisites.sh script`, `common.sh script`, `create-new-feature.sh script`, `setup-plan.sh script`, `setup-tasks.sh script` (+277 more)
